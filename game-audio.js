class GameAudio {
    ...
    playSound(type) {
        ...
        switch (type) {
            ...
            // Nový zvuk pro sebrání předmětu
            case 'collectible': o.frequency.setValueAtTime(800, t); o.frequency.exponentialRampToValueAtTime(1600, t + 0.05); g.gain.setValueAtTime(0.15, t); break;
        }
