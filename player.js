...
export class Player {
    ...
    update(delta = 1 / 60) {
        ...
        // Důležité: nikdy tady nepřepisujeme playerGroup.position.y.
        // Výšku hráče řídí GameLogic kvůli skoku a kolizím.
        if (this.boardGroup) {
            this.boardGroup.position.y = Math.sin(t * 2.2) * 0.12;
            this.boardGroup.rotation.z = Math.cos(t * 1.8) * 0.04;
        }
        ...
        if (this.thrusters) {
            this.thrusters.rotation.y += safeDelta * 3;
